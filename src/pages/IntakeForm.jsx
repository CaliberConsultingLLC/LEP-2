...
import { requirementLabelFor } from '../data/newIntakeQuestions';
...
function IntakeForm() {
  ...
  // The Daily Behaviors chapter. Defined in src/data/intakeBehaviorSet.js so
  // the read-only ledger at /revisit/intake reads the leader's answers back
  // against the same array the form asked them from.
  const behaviorSet = INTAKE_BEHAVIOR_SET;
