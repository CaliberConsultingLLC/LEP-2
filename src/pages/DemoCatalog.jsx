    ...
    pages: [
      {
        ...
        in: ['mid', 'finished'],
        hint: 'The guide stands here now rather than starting collapsed; it sinks past the Choose buttons.',
      },
      {
        label: 'Campaign builder',
        path: '/campaign-builder',
        in: ['mid', 'finished'],
        hint: 'Guide bubble solved around both nav controls — the footer reserves the guide’s corner.',
      },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        in: ['finished'],
        hint: 'The five statements and their scores are keep-clear; the guide is solved around them.',
      },
      {
        label: 'Action plan',
        path: '/dashboard?tab=practice',
        in: ['finished'],
        hint: 'Opens on the field journal’s interruption — the large owl, with its line anchored off the head.',
      },
