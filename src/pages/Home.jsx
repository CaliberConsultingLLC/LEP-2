  ...
  const processCards = [
    {
      ...
      points: [
        ...
        'Your responses are translated into measurable signals for comparison later.',
      ],
    },
    {
      title: 'Reflect',
      ...
      points: [
        ...
        'Choose clear priorities you can explain and use with your team.',
      ],
    },
    {
      title: 'Calibrate',
      ...
      points: [
        ...
        'Turn key gaps into focused behavior targets for immediate improvement.',
      ],
    },
    {
      title: 'Embark',
      ...
      points: [
        ...
        'Track progress and recalibrate through structured check-ins.',
      ],
    },
  ];
