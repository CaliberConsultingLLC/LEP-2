...
const colorTokens = [
  ...
  ['journeyPaper', colors.journeyPaper],
  ['journeyMap', colors.journeyMap],
  ['journeyEdge', colors.journeyEdge],
  ['journeyGutter', colors.journeyGutter],
  ['journeyTan', colors.journeyTan],
  ['journeyTanLight', colors.journeyTanLight],
  ['journeyGold', colors.journeyGold],
  ['journeyNavy', colors.journeyNavy],
  ['journeyInk', colors.journeyInk],
  ['journeyInkSoft', colors.journeyInkSoft],
