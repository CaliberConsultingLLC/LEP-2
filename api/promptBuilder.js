...
2) Trajectory: 3–4 full sentences. Start with one positive future case, then focus the rest on the trajectory if they do not address current weaknesses/obstacles (not doom-gloom; grounded urgency). Allow similar length to Snapshot.
